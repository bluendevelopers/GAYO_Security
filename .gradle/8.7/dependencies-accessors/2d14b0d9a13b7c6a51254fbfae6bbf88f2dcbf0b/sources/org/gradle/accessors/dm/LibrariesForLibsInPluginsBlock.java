...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ButterknifeLibraryAccessors laccForButterknifeLibraryAccessors = new ButterknifeLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>butterknife</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ButterknifeLibraryAccessors getButterknife() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForButterknifeLibraryAccessors;
    }
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>slidr</b> with <b>com.github.florent37:android-slidr</b> coordinates and
         * with version reference <b>androidSlidr</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getSlidr() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("android.slidr");
        }
     ...
     */
    @Deprecated
    public static class ButterknifeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public ButterknifeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>butterknife</b> with <b>com.jakewharton:butterknife</b> coordinates and
         * with version reference <b>butterknife</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("butterknife");
        }

        /**
         * Dependency provider for <b>compiler</b> with <b>com.jakewharton:butterknife-compiler</b> coordinates and
         * with version reference <b>butterknife</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getCompiler() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("butterknife.compiler");
        }
    ...
    public static class GoogleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>webrtc</b> with <b>org.webrtc:google-webrtc</b> coordinates and
         * with version reference <b>googleWebrtc</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidSlidr</b> with value <b>1.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidSlidr() { return getVersion("androidSlidr"); }
        ...
        /**
         * Version alias <b>butterknife</b> with value <b>10.2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleWebrtc</b> with value <b>1.0.32006</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleWebrtc() { return getVersion("googleWebrtc"); }
