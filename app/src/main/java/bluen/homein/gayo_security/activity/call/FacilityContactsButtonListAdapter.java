...
public class FacilityContactsButtonListAdapter extends BaseRecyclerAdapter<ResponseDataFormat.FacilityContactListBody.FacilityContactInfo, FacilityContactsButtonListAdapter.ViewHolder> {
    private OnContactsClickListener listener;  // 콜백 인터페이스 변수

    public FacilityContactsButtonListAdapter(Context context, int resource, OnContactsClickListener listener) {
